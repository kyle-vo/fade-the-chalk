...
<style>.vsw{{margin-left:auto;display:inline-flex;border:1px solid var(--line);border-radius:6px;overflow:hidden}}.vb{{background:var(--panel);color:var(--mute);border:0;padding:5px 12px;cursor:pointer;font:inherit}}.vb.on{{background:#1b2129;color:var(--ink)}}#slate{{max-width:1100px}}.sday{{font-family:var(--disp);font-size:18px;letter-spacing:1.5px;text-transform:uppercase;color:#fff;background:linear-gradient(90deg,#1d4ed8,#1e3a8a);padding:4px 12px;margin:10px 0 6px;border-radius:4px}}.sday:first-child{{margin-top:0}}.sgrid{{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:6px}}.mrow{{display:grid;grid-template-columns:1fr 1fr 74px;align-items:stretch;background:#0e1115;border:1px solid var(--line);border-radius:6px;overflow:hidden;height:52px}}.mrow .t{{display:flex;align-items:center;gap:6px;padding:0 8px;opacity:.5;border-bottom:3px solid transparent}}.mrow .t img{{width:30px;height:30px;object-fit:contain;flex:none}}.mrow .t .ab{{font-family:var(--disp);font-size:16px;letter-spacing:.8px;line-height:1}}.mrow .t .pr{{font:10px var(--mono);color:var(--mute);display:block;margin-top:2px}}.mrow .t.pick{{opacity:1;background:#1c1706;border-bottom-color:var(--acc)}}.mrow .t.pick .pr{{color:var(--acc)}}.mrow.strong .t.pick{{background:#0d2016;border-bottom-color:var(--good)}}.mrow.strong .t.pick .pr{{color:var(--good)}}.mrow.pass .t.pick{{background:#151a21;border-bottom-color:#3a4450}}.mrow.pass .t.pick .pr{{color:var(--mute)}}.mrow .info{{display:flex;flex-direction:column;justify-content:center;align-items:center;background:#161c24;font:10px var(--mono);color:var(--mute);gap:2px;border-left:1px solid var(--line)}}.mrow .info .tm{{color:var(--ink);font-size:11px;white-space:nowrap}}.mrow .info .v{{font-weight:700;letter-spacing:.4px}}.mrow .info .v.strong{{color:var(--good)}}.mrow .info .v.bet{{color:var(--blue)}}.mrow.won{{border-color:#1f6b3e}}.mrow.lost{{border-color:#7a2a34}}.mrow .info .res{{font-weight:700}}.mrow.won .info .res{{color:var(--good)}}.mrow.lost .info .res{{color:var(--bad)}}.mrow .t.winner .ab{{text-decoration:underline;text-decoration-color:var(--good);text-decoration-thickness:2px;text-underline-offset:3px}}@media(max-width:600px){{.sgrid{{grid-template-columns:1fr 1fr}}}}</style>
