...
.v.FADEdog{background:#3a2a10;color:var(--warn)}.v.BET{background:#123d26;color:var(--good)}.v.LEAN{background:#12304a;color:var(--blue)}.v.AVOID{background:#4a1218;color:var(--bad)}.v.SLEEPER{background:#123d26;color:var(--good)}.v.VALUE{background:#12304a;color:var(--blue)}.v.TRAP,.v.FADE{background:#4a1218;color:var(--bad)}.v.CHALK{background:#463610;color:var(--warn)}.v.PASS,.v.DONE{background:#20262e;color:var(--mute)}.v.STRONGBET{background:#123d26;color:var(--good)}.v.BET{background:#12304a;color:var(--blue)}.v.PASSpricedin,.v.PASStooexpensive,.v.PASSnoPinnacle{background:#20262e;color:var(--mute)}
...
const strat = {
  ...
  'TD VERDICT BET: public 65%+ on his team': d => d !== dates[0] ? [] : H.filter(r => r.hit != null && !r.dnp && r.sport === 'NFL' && r.teamPub != null && r.teamPub >= .65),
  'TD VERDICT AVOID: underdog or public against his team': d => d !== dates[0] ? [] : H.filter(r => r.hit != null && !r.dnp && r.sport === 'NFL' && !(r.teamPub != null && r.teamPub >= .65) && (r.teamFav === false || (r.teamPub != null && r.teamPub < .5))),
